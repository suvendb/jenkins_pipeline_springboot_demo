    ...
    stages{
        ...
        stage('NotifyByEmail'){
            steps{
                ...
                Check console output at $BUILD_URL, Artifacts list at $RUN_ARTIFACTS_DISPLAY_URL to view the results.''', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS!', to: 'subha.indu123@gmail.com'
            }
        }
    }
}
